...
export default function App() {
 ...
 'theme-mother-green', 'theme-merry-magenta', 'theme-synthetic-violet', 
 'theme-acid-yellow', 'theme-cryo-cyan', 'theme-solar-orange',
 'crt-off', 'crt-clean', 'crt-aged'
 );
...
/>
 ...
 <span className="font-bold block uppercase tracking-wider">ERR // SYNTHESIS INTERRUPTED</span>
 ...
 <PromptInputArea davidState={davidState}
 concept={concept}
 ...
 <span>&bull;</span>
 <span className="text-phosphor/80">&ldquo;May I speak to David?&rdquo;</span>
 </div>
